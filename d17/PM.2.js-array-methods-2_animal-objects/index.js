...
const listOfWeightOfAllAnimalsInAfrica = animalsInAfrica.map(
  (animal) => animal.weight
);

const weightOfAllAnimalsInAfrica = listOfWeightOfAllAnimalsInAfrica.reduce(
...
const averageWeightOfAllAnimalsInAfrica =
  weightOfAllAnimalsInAfrica / numberOfAnimalsInAfrica;

// using method chaining
const averageWeightOfAllAnimalsInAfricaChained =
  animals
...
console.log(
  "avg weight of animals in africa (using variables):",
  averageWeightOfAllAnimalsInAfrica
);
console.log(
  "avg weight of animals in africa (method chaining):",
  averageWeightOfAllAnimalsInAfricaChained
);
